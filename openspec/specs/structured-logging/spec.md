...
Structured (pino) logging across all server-side modules, replacing ad-hoc console output, with human-readable dev output, JSON production output, trace-id correlation, and OTLP log shipping when telemetry is enabled.
