...
Let any authenticated user annotate chronicle entries with period-styled glosses (comments) in an illuminated manuscript margin — including one-shot "Huzzah!" reactions, author-only blotting (soft delete) and chiseling (hard delete), deterministic ink styling, and bilingual period copy.
