...
This spec defines the sound effects behavior for the Brick Master Tracker, covering the SFX toggle, the transfer sword sound, and the use of pre-rendered audio assets.
