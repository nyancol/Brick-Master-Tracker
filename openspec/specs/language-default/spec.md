...
This spec defines how the app resolves its initial/default language: device locale detection (French or English only), French as the catch-all fallback, and a stored user preference taking precedence over detection.
