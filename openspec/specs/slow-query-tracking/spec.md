...
Wall-clock timing of SQLite statement execution via a transparent wrapper around `better-sqlite3`, logging statements that exceed a configurable threshold as structured warnings.
