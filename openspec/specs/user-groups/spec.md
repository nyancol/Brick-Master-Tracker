...
Derive and persist a per-user role (`knight` or `visitor`) from OIDC group memberships, expose it through the API, and reflect it in the UI (visitor banner and header role badge).
