...
This spec defines the manual EN/FR language selector control: its presence on the gate entry page and the home header, active-language indication, immediate re-render of the UI in the chosen language, and persistence of the explicit choice.
